...
class arInstall
{
    ...
    public static function createDatabasesYml()
    {
        ...
        // databases.yml.tmpl (for a Subversion checkout), or symfony
    ...
    public static function createPropelIni()
    {
        ...
        // propel.ini.tmpl (for a Subversion checkout), or symfony
    ...
    public static function createSettingsYml()
    {
        ...
        // settings.yml.tmpl (for a Subversion checkout), or symfony
