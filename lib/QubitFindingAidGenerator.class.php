...
class QubitFindingAidGenerator
{
     ...
     *
     * @return null|string path to cache file, null if there is no cache file
     */
    public function getEadCacheFilePath(QubitInformationObject $resource): ?string
    {
